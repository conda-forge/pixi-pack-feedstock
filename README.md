...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/pixi-pack-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pixi-pack-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add pixi-pack pixi-unpack
...
It is possible to list all of the versions of `pixi-pack` available on your platform:
...
```
pixi search pixi-pack --channel conda-forge
```
